...
class TestGetOrderByTrack:
    ...
    def test_get_order_by_track_without_track_returns_error(self, finish_order_by_track):
    ...
    def test_get_order_by_track_with_non_existent_track_returns_error(self, finish_order_by_track):
